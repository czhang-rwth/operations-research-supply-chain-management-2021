...
def solve_LP_and_fix(C, f, c, d, I, J):
    
    def solve_LP(C, f, c, d, I, J):
    ...
    def solve_MIP_LP_FIX(C, f, c, d, I, J, y_bar):
        ...
        for i in I:
            if y_bar[i] == 0 or y_bar[i] == 1:
                model.addConstr(y[i] == y_bar[i])
    ...
    y_bar = solve_LP(C, f, c, d, I, J)
    
    print(y_bar)
    
    assignments, open_depots, total_cost = solve_MIP_LP_FIX(C, f, c, d, I, J, y_bar)
    
    return assignments, open_depots, total_cost
    

assignments, open_depots, total_cost = solve_LP_and_fix(C, f, c, d, I, J)
